...
from solvers_cur_bias import  CURdecomposition
...
def main():
    ...
    for ii, sketch in enumerate(sketches):
        # loss_sketch=torch.tensor(losses_cur[sketch])
        ...
        losses_cur_sketch_mean = losses_cur_sketch
        ...
        losses_cur_sketch_mean_debia = losses_cur_sketch_debia
    ...
    for ii, sketch in enumerate(sketches):
        ...
        times_cur_sketch_mean = times_cur_sketch 
        ...
        times_cur_sketch_mean_debia = times_cur_sketch_debia
